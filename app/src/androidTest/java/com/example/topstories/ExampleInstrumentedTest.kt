...
class ExampleInstrumentedTest {
    ...
    @Test
    fun SeeMoreButtonNotDisplayedTest() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.layout?.settings?.showMore = false
                VLHighlightTray01(module = main)
            }

        }
        composeTestRule.onNodeWithTag("SEEMOREBTN").assertDoesNotExist()
...
//            listener = listener
    ...
    fun CheckShareButtonVisibilityIsVisible() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.layout?.settings?.enableSharing = true
                VLHighlightTray01(module = main)
            }
        }
    ...
    fun CheckShareButtonVisibilityIsInvisible() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.layout?.settings?.enableSharing = false
                VLHighlightTray01(module = main)
            }
        }
        val shareIcon = composeTestRule.onNodeWithTag("SHAREICON")
    ...
    fun CheckTopThumbailNailExist() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.layout?.settings?.thumbnailPlacement = "TOP"
                when (main.layout?.settings?.thumbnailPlacement) {
                    "TOP" -> {
                        Log.e("hdbd", "TOP")
                        HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
                    }
                    "LEFT" -> {
                        Log.e("hdbd", "LEFt")
                        HighlightLeftImageTrayItem(main.contentData.first(), main.layout, false)
                    }
                    "RIGHT" -> {
                        Log.e("hdbd", "Rght")
                        HighlightRightImageTrayItem(main.contentData.first(), main.layout, false)
                    }
                    else -> {
                        Log.e("hdbd", "ELSE")
                        HighlightLeftImageTrayItem(main.contentData.first(), main.layout, false)
    ...
    fun CheckLeftThumbailNailExist() {
        composeTestRule.setContent {
            ...
            val main = gson.fromJson(json, Module::class.java)
            TopStoriesTheme {
                main.layout?.settings?.thumbnailPlacement = "LEFT"
                when (main.layout?.settings?.thumbnailPlacement) {
                    "TOP" -> {
                        HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
                    }
    ...
    fun CheckRightThumbailNailExist() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.layout?.settings?.thumbnailPlacement = "RIGHT"
                when (main.layout?.settings?.thumbnailPlacement) {
                    "TOP" -> {
                        HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
                    }
    ...
    fun CheckShowDurationIsVisibleWithTimeAndAuthor() {
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.contentData.first().publishDate = 1678898189
                main.contentData.first().author = "Christian Plank"
                HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
            }
        }
        composeTestRule.onRoot().printToLog("TAG")
        ...
        textNode.assertExists()
        textNode.assertTextEquals("32d • Christian Plank")
    }
    ...
    fun CheckShowDurationIsVisibleWithTimeOnly(){
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.contentData.first().publishDate = 1678898189
                main.contentData.first().author = null
                HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
            }
        }
        composeTestRule.onRoot().printToLog("TAG")
    ...
    fun CheckShowDurationIsVisibleWithAuthorNameOnly(){
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                main.contentData.first().publishDate = null
                main.contentData.first().author = "Christian Plank"
                HighlightTopImageTrayItem(main.contentData.first(), main.layout, false)
            }
        }
    ...
    fun CheckZeroItemInTopStory(){
        composeTestRule.setContent {
            ...
            TopStoriesTheme {
                VLVerticalGrid(dataList = emptyList(), layout = main.layout)
            }
        }
        composeTestRule.onRoot().printToLog("TAG")
